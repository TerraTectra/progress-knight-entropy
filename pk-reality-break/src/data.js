...
export const jobCategories = {
  ...
  Military: [
    ...
    { name: "Footman", maxXp: 1300, income: 12, req: { all: [{ task: "Squire", level: 10 }, { task: "Endurance", level: 15 }] } },
    { name: "Veteran footman", maxXp: 14000, income: 48, req: { all: [{ task: "Footman", level: 10 }, { task: "Weapon handling", level: 25 }] } },
    { name: "Knight", maxXp: 140000, income: 130, req: { all: [{ task: "Veteran footman", level: 10 }, { task: "Battle tactics", level: 60 }] } },
    { name: "Veteran knight", maxXp: 1300000, income: 420, req: { all: [{ task: "Knight", level: 10 }, { task: "Guard discipline", level: 90 }] } },
    { name: "Elite knight", maxXp: 12000000, income: 1400, req: { all: [{ task: "Veteran knight", level: 10 }, { task: "Muscle memory", level: 120 }] } },
    { name: "Holy knight", maxXp: 100000000, income: 5200, req: { all: [{ task: "Elite knight", level: 10 }, { task: "Mana control", level: 90 }] } },
    { name: "Legendary knight", maxXp: 900000000, income: 21000, req: { all: [{ task: "Holy knight", level: 10 }, { task: "Time warping", level: 60 }] } },
  ],
  "The Arcane Association": [
    { name: "Student", maxXp: 45000, income: 55, req: { task: "Mana control", level: 1 } },
    { name: "Apprentice mage", maxXp: 180000, income: 420, req: { all: [{ task: "Student", level: 10 }, { task: "Mana control", level: 40 }] } },
    { name: "Mage", maxXp: 650000, income: 2600, req: { all: [{ task: "Apprentice mage", level: 10 }, { task: "Mana control", level: 85 }] } },
    { name: "Wizard", maxXp: 2200000, income: 15500, req: { all: [{ task: "Mage", level: 10 }, { task: "Immortality", level: 25 }] } },
    { name: "Master wizard", maxXp: 8500000, income: 85000, req: { all: [{ task: "Wizard", level: 10 }, { task: "Time warping", level: 60 }] } },
    { name: "Chairman", maxXp: 42000000, income: 480000, req: { all: [{ task: "Master wizard", level: 10 }, { task: "Super immortality", level: 35 }] } },
  ],
};
...
export const skillCategories = {
  ...
  Combat: [
    ...
    { name: "Endurance", maxXp: 105, desc: "Military pay", req: { task: "Strength", level: 8 } },
    { name: "Weapon handling", maxXp: 110, desc: "Military pay", req: { task: "Strength", level: 15 } },
    { name: "Guard discipline", maxXp: 115, desc: "Military XP", req: { all: [{ task: "Endurance", level: 15 }, { task: "Concentration", level: 20 }] } },
    { name: "Battle tactics", maxXp: 120, desc: "Military XP", req: { all: [{ task: "Concentration", level: 20 }, { task: "Weapon handling", level: 20 }] } },
    { name: "Muscle memory", maxXp: 125, desc: "Strength XP", req: { all: [{ task: "Concentration", level: 30 }, { task: "Strength", level: 30 }, { task: "Weapon handling", level: 25 }] } },
  ],
  Magic: [
    ...
    { name: "Super immortality", maxXp: 100, desc: "Longer lifespan", req: { all: [{ task: "Time warping", level: 80 }, { task: "Immortality", level: 80 }] } },
  ],
  "Dark magic": [
...
export const miscItems = [
  ...
  { name: "Research notes", expense: 95, effect: 1.14, desc: "Skill XP", req: { task: "Mana control", level: 10 } },
  ...
  { name: "Sapphire charm", expense: 520, effect: 1.15, desc: "T.A.A. XP", req: { task: "Student", level: 5 } },
  { name: "Apprentice grimoire", expense: 840, effect: 1.18, desc: "T.A.A. XP", req: { task: "Apprentice mage", level: 5 } },
...
export const EVIL_PERKS = [
  { id: "shadowDiscipline", name: "Shadow Discipline", cost: 20, req: {}, effect: "+25% all XP" },
  { id: "darkPatronage", name: "Dark Patronage", cost: 55, req: { all: [{ perk: "shadowDiscipline" }, { task: "Dark influence", level: 25 }] }, effect: "+15% income" },
  { id: "wickedBargain", name: "Wicked Bargain", cost: 120, req: { all: [{ perk: "darkPatronage" }, { task: "Intimidation", level: 60 }] }, effect: "-15% expenses" },
  { id: "soulFurnace", name: "Soul Furnace", cost: 220, req: { all: [{ perk: "darkPatronage" }, { task: "Evil control", level: 90 }, { task: "Blood meditation", level: 25 }] }, effect: "+60% Evil gain" },
  { id: "deathDefiance", name: "Death Defiance", cost: 420, req: { all: [{ perk: "soulFurnace" }, { task: "Immortality", level: 110 }, { task: "Blood meditation", level: 60 }] }, effect: "+30 years lifespan" },
  { id: "demonicAutomation", name: "Demonic Automation", cost: 700, req: { all: [{ perk: "wickedBargain" }, { task: "Demon's wealth", level: 60 }, { task: "Merchant", level: 150 }] }, effect: "+50% XP while automation is enabled" },
  { id: "realityBreak", name: "Reality Break", cost: 1200, req: { all: [{ perk: "deathDefiance" }, { perk: "demonicAutomation" }, { task: "Dark influence", level: 150 }, { task: "Demon training", level: 110 }, { task: "Blood meditation", level: 90 }, { task: "Evil control", level: 140 }] }, effect: "Open multiverse" },
];
