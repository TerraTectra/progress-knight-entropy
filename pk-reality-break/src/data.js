...
export const jobCategories = {
  ...
  Military: [
    ...
    { name: "Holy knight", maxXp: 100000000, income: 5200, req: { all: [{ task: "Elite knight", level: 10 }, { task: "Mana control", level: 250 }] } },
    { name: "Legendary knight", maxXp: 900000000, income: 21000, req: { all: [{ task: "Holy knight", level: 10 }, { task: "Time warping", level: 100 }] } },
  ],
  "The Arcane Association": [
    ...
    { name: "Wizard", maxXp: 140000000, income: 13000, req: { all: [{ task: "Mage", level: 10 }, { task: "Immortality", level: 100 }] } },
    { name: "Master wizard", maxXp: 1400000000, income: 70000, req: { all: [{ task: "Wizard", level: 10 }, { task: "Time warping", level: 200 }] } },
    { name: "Chairman", maxXp: 12000000000, income: 420000, req: { all: [{ task: "Master wizard", level: 10 }, { task: "Super immortality", level: 100 }] } },
  ],
};
...
export const miscItems = [
  ...
  { name: "Research notes", expense: 95, effect: 1.14, desc: "Skill XP", req: { task: "Mana control", level: 50 } },
...
export const EVIL_PERKS = [
  ...
  { id: "deathDefiance", name: "Death Defiance", cost: 75, req: { all: [{ perk: "soulFurnace" }, { task: "Immortality", level: 100 }] }, effect: "+30 years lifespan" },
