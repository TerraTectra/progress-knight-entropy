...
export const CONTACTS = [
  { label: "Team", value: "TectraGames" },
  { label: "Email", value: "luter.rouze@gmail.com" },
...
export const RU = {
  ...
  "Evil Perks": "Перки зла", Multiverse: "Мультивселенная", Observer: "Наблюдатель", Automation: "Автоматизация", Log: "Журнал",
  ...
  Character: "Персонаж", Age: "Возраст", Lifespan: "Срок жизни", Housing: "Жильё",
  Money: "Деньги", Balance: "Баланс", Income: "Доход", Expense: "Расход", Net: "Итог",
  "Auto job": "Авторабота", "Auto skill": "Авто-навык", "Time warp": "Искажение времени (вкл.)", "Auto shop": "Автомагазин",
  Properties: "Жильё", Items: "Предметы",
  "Touch the eye": "Прикоснуться к глазу", "Embrace evil": "Принять зло", "The amulet preserves the limits of your past lives and grants a memory multiplier.": "Амулет сохраняет пределы прошлых жизней и даёт множитель памяти.",
  Bought: "Куплено",
  Universes: "Вселенные", "Global upgrades": "Глобальные улучшения", Collapse: "Схлопнуть", "Unreadable Perk": "Нечитаемый перк", Enter: "Войти", Unlock: "Открыть",
  "Buy simulacrum": "Купить симулякра", Simulacra: "Симулякры", Upgrades: "Улучшения",
  Continue: "Продолжить", Pause: "Пауза", "Full reset": "Полный сброс", "Open Universe X": "Открыть вселенную X",

  "Next job": "Следующая работа", "Next skill": "Следующий навык", "Next housing": "Следующее жильё", "Next item": "Следующий предмет",
  Requirement: "Требование", "Next branch": "Следующая ветка",
  Level: "Уровень", "XP left": "До уровня",

  "Total progress": "Общий прогресс", "Show only incomplete": "Показывать только невыполненные",
  "Current stage": "Текущий этап", completed: "выполнено",
  "All achievements in this stage are complete.": "Все достижения этого этапа уже выполнены.",
  Progress: "Прогресс", Done: "Готово", Reward: "Награда",

  Active: "Активно", Cost: "Расход", Bonus: "Бонус", "No bonus": "Без бонуса",

  Team: "Команда", Email: "Почта",
  "For collaboration questions or voluntary support, write to Telegram @tahioff or email luter.rouze@gmail.com.":
    "По вопросам сотрудничества или добровольной поддержки пишите в Telegram @tahioff или на почту luter.rouze@gmail.com.",
