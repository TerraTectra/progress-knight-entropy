...
const translations = {
    ui: {
        ...
        entropy_seeds_hint: { en: "Seeds just show your Almanach is bound (1+). Universe travel depends on Entropy upgrades and tokens, not seeds.", ru: "Семена лишь показывают, что Альманах привязан (1+). Путешествие между вселенными зависит от энтропийных улучшений и токенов, а не от семян." },
