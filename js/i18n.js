...
const translations = {
    ui: {
        ...
        confirm_universe_travel: { en: "You have stabilized this universe. Spend your token to travel to the next one?", ru: "Вы стабилизировали эту вселенную. Потратить жетон, чтобы перейти в следующую?" },
        ...
        entropy_ledger_note: { en: "Passive actions gain XP and a small income; active jobs earn much more.", ru: "Пассивные действия дают опыт и небольшой доход; активные работы приносят гораздо больше." },
        entropy_seeds_label: { en: "Seeds:", ru: "Семена:" },
        entropy_seeds_hint: { en: "Seeds are persistent. They are not spent between lives or universes, and are used for meta-upgrades and boosting some improvements.", ru: "Семена — постоянный ресурс. Не тратятся между жизнями и вселенными, используются для мета-улучшений и усиления некоторых улучшений." },
        ...
        entropy_focus_tooltip: { en: "Overseer focuses fully on one task while others train softly.", ru: "Наблюдатель полностью фокусируется на одной задаче, остальные тренируются мягко." },
        ...
        entropy_overseer_tooltip: { en: "Overseer drives one chosen task at full strength; others tick along slowly.", ru: "Наблюдатель ведёт выбранную задачу на полной мощности, остальные идут медленно." },
        ...
        entropy_upgrade_velocity_chainProgression_desc: { en: "Switch faster. Benefits grow as your Seeds increase.", ru: "Быстрее переключаться. Становится ценнее по мере роста семян." },
        ...
        entropy_upgrade_stability_entropyStability_desc: { en: "Gentle steadiness. Benefits grow as your Seeds increase.", ru: "Мягкая устойчивость. Становится ценнее по мере роста семян." },
        ...
        entropy_upgrade_stability_shortBrilliantLife_desc: { en: "Bright, early lives. Makes short-life runs easier and lets the amulet end lives earlier.", ru: "Яркие короткие жизни. Упрощает короткие пробежки и позволяет амулету завершать жизнь раньше." },
        ...
        entropy_upgrade_meta_unifiedArchitecture_desc: { en: "Finalize this universe's entropy, gain a stability token, and unlock travel to the next universe.", ru: "Завершить энтропию этой вселенной, получить токен стабильности и открыть переход в следующую вселенную." },
        entropy_unifiedArchitecture_tooltip: { en: "Freezes entropy growth for this universe and awards a stability token to travel onward.", ru: "Замораживает рост энтропии в этой вселенной и даёт токен стабильности для перехода дальше." },
        entropy_unifiedArchitecture_requirements_title: { en: "Requirements:", ru: "Требуется:" },
        entropy_unifiedArchitecture_requirements_seeds: { en: "Seeds", ru: "Семена" },
        entropy_unifiedArchitecture_requirements_patterns: { en: "Patterns", ru: "Паттерны" },
        entropy_unifiedArchitecture_requirement_missing: { en: "Requirements not met yet.", ru: "Требования пока не выполнены." },
        ...
        entropy_artifact_u2_echoSeeds_name: { en: "Echo of Seeds", ru: "Эхо семян" },
        entropy_artifact_u2_echoSeeds_desc: { en: "Increases Seeds gained per life.", ru: "Увеличивает количество Seeds, получаемых за жизнь." },
        entropy_artifact_u2_fracturedTimeline_name: { en: "Fractured Timeline", ru: "Рассечённая хронология" },
        entropy_artifact_u2_fracturedTimeline_desc: { en: "Boosts gains from short lives and compressedLife.", ru: "Усиливает выгоду от коротких жизней и паттерна compressedLife." },
        entropy_artifact_u2_evilResonator_name: { en: "Evil Resonator", ru: "Резонатор зла" },
        entropy_artifact_u2_evilResonator_desc: { en: "Your Evil power amplifies XP gains.", ru: "Твоя сила зла усиливает прирост опыта." },
        entropy_artifact_u2_patternLattice_name: { en: "Pattern Lattice", ru: "Решётка паттернов" },
        entropy_artifact_u2_patternLattice_desc: { en: "Each pattern level slightly boosts Entropy growth.", ru: "Каждый уровень паттернов слегка усиливает прирост Энтропии." },
        entropy_u2_artifacts_title: { en: "Higher-Order Artifacts (U2+)", ru: "Артефакты высших вселенных (U2+)" },
        entropy_u2_artifacts_hint: { en: "Available starting in Universe II. Focused on Seeds, short lives, Evil, and pattern growth.", ru: "Доступны начиная со Вселенной II. Усиливают Seeds, короткие жизни, зло и рост паттернов." },
        entropy_pattern_laborCycle_name: { en: "Labor Cycle", ru: "Цикл труда" },
        entropy_pattern_laborCycle_desc: { en: "You spend most of your life working.", ru: "Ты проводишь большую часть жизни в работе." },
        entropy_pattern_scholarLoop_name: { en: "Scholar Loop", ru: "Круг учёного" },
        entropy_pattern_scholarLoop_desc: { en: "You spend most of your life studying.", ru: "Ты проводишь большую часть жизни за обучением." },
        entropy_pattern_compressedLife_name: { en: "Compressed Life", ru: "Сжатая жизнь" },
        entropy_pattern_compressedLife_desc: { en: "You live short, intense lives. Gains XP when you rebirth below ~30% of your lifespan.", ru: "Ты живёшь коротко, но ярко. Получает опыт, если переродиться моложе ~30% текущей продолжительности жизни." },
        entropy_pattern_stableCycle_name: { en: "Stable Cycle", ru: "Стабильный цикл" },
        entropy_pattern_stableCycle_desc: { en: "You live long, balanced lives.", ru: "Ты живёшь долго и сбалансированно." },
        entropy_pattern_opportunist_name: { en: "Opportunist", ru: "Оппортунист" },
        entropy_pattern_opportunist_desc: { en: "You lean on auto-switching and mixed focus.", ru: "Ты опираешься на авто-переключение и смешанный фокус." },
        entropy_pattern_discovered_prefix: { en: "New pattern discovered:", ru: "Обнаружен новый паттерн:" },
        ...
        entropy_short_life_hint: { en: "Short life: ending a life below ~30% of current lifespan grants compressedLife XP. Short Brilliant Life makes this easier and unlocks earlier rebirth via the amulet.", ru: "Короткая жизнь: завершение жизни моложе ~30% текущей продолжительности даёт опыт паттерну compressedLife. «Короткая яркая жизнь» облегчает это и раньше открывает перерождение через амулет." },
        ...
        tab_achievements: { en: "Achievements", ru: "Достижения" },
        tab_challenges: { en: "Challenges", ru: "Испытания" },
        ...
        achievements_title: { en: "Achievements", ru: "Достижения" },
        challenges_title: { en: "Challenges", ru: "Испытания" },
        achievement_overlay_title: { en: "Achievement unlocked!", ru: "Достижение получено!" },
        achievement_status_unlocked: { en: "Unlocked", ru: "Открыто" },
        achievement_status_locked: { en: "Locked", ru: "Закрыто" },
        challenge_status_placeholder: { en: "Coming soon", ru: "Скоро" },
        ch_status_completed: { en: "Completed", ru: "Завершено" },
        ch_status_active: { en: "Active", ru: "Активно" },
        ch_status_available: { en: "Available", ru: "Доступно" },
        ch_button_start: { en: "Start", ru: "Начать" },
        ch_completed_title: { en: "Challenge completed!", ru: "Испытание выполнено!" },
        ch_reward_prefix: { en: "Reward", ru: "Награда" },
        ch_reward_seeds: { en: "Seeds", ru: "Семена" },
        ch_reward_evil: { en: "Evil", ru: "Зло" },
        ch_evil_disabled: { en: "Evil is disabled for this challenge.", ru: "Зло отключено в этом испытании." },
        ch_shop_disabled: { en: "Shop purchases are disabled in this challenge.", ru: "Покупки в магазине недоступны в этом испытании." },
        ch_dark_magic_disabled: { en: "Dark magic is sealed in this challenge.", ru: "Тёмная магия запечатана в этом испытании." },
        ch_force_short_life_hint: { en: "This challenge favors short lives. Rebirth early!", ru: "Испытание требует коротких жизней. Перерождайтесь раньше!" },
        ch_confirm_switch: { en: "Starting this challenge will abandon your current one. Continue?", ru: "Запуск испытания отменит текущее. Продолжить?" },
        ch_entropy_purist_name: { en: "Entropy Purist", ru: "Чистый энтропист" },
        ch_entropy_purist_desc: { en: "No Evil, no dark magic. Reach Universe II on pure entropy.", ru: "Без зла и тёмной магии доберитесь до Вселенной II, полагаясь на энтропию." },
        ch_evil_lord_name: { en: "Evil Lord", ru: "Повелитель зла" },
        ch_evil_lord_desc: { en: "Shop is off-limits. Amass 2000 Evil with boosted gains.", ru: "Магазин закрыт. Соберите 2000 зла с повышенным приростом." },
        ch_shortlife_master_name: { en: "Short-life Master", ru: "Мастер коротких жизней" },
        ch_shortlife_master_desc: { en: "Live fast: complete 3 perfect short-life runs.", ru: "Живите быстро: выполните 3 идеальных коротких жизни." },
        ch_pattern_weaver_name: { en: "Pattern Weaver", ru: "Ткач паттернов" },
        ch_pattern_weaver_desc: { en: "With slowed growth, weave patterns to 40 total levels.", ru: "При замедленном росте доведите паттерны до 40 суммарных уровней." },
        achv_group_progress: { en: "Progress", ru: "Прогресс" },
        achv_group_entropy: { en: "Entropy", ru: "Энтропия" },
        achv_group_evil: { en: "Evil", ru: "Зло" },
        achv_group_patterns: { en: "Patterns", ru: "Паттерны" },
        achv_group_lifetime: { en: "Lifetime", ru: "Жизни" },
        achv_reach_u2_name: { en: "Beyond the First", ru: "За пределы первой" },
        achv_reach_u2_desc: { en: "Reach Universe II and unlock new horizons.", ru: "Доберитесь до Вселенной II и откройте новый рубеж." },
        achv_seeds_5_name: { en: "Seed Collector", ru: "Собиратель семян" },
        achv_seeds_5_desc: { en: "Gather at least 5 Seeds.", ru: "Соберите минимум 5 семян." },
        achv_seeds_25_name: { en: "Seed Harvester", ru: "Жнец семян" },
        achv_seeds_25_desc: { en: "Accumulate 25 Seeds to fuel entropy.", ru: "Накопите 25 семян для разгона энтропии." },
        achv_evil_once_name: { en: "First Embrace", ru: "Первое принятие зла" },
        achv_evil_once_desc: { en: "Embrace evil at least once.", ru: "Примите зло хотя бы один раз." },
        achv_evil_500_name: { en: "Evil Reservoir", ru: "Резервуар зла" },
        achv_evil_500_desc: { en: "Hold 500 Evil at once.", ru: "Держите 500 зла одновременно." },
        achv_patterns_20_name: { en: "Pattern Weaver", ru: "Ткач паттернов" },
        achv_patterns_20_desc: { en: "Reach a total of 20 pattern levels.", ru: "Достигните суммарно 20 уровней паттернов." },
        achv_shortlife_name: { en: "Perfect Short Life", ru: "Идеальная короткая жизнь" },
        achv_shortlife_desc: { en: "Complete a perfect short-life run.", ru: "Сделайте идеальный забег в короткой жизни." },
        achv_u2_artifact_name: { en: "Echoes of U2", ru: "Эхо второй вселенной" },
        achv_u2_artifact_desc: { en: "Acquire any Universe II artifact.", ru: "Получите любой артефакт второй вселенной." },
        achv_entropy_1e6_name: { en: "Entropy Millionaire", ru: "Энтропийный миллионер" },
        achv_entropy_1e6_desc: { en: "Reach 1,000,000 total EP.", ru: "Наберите 1 000 000 очков энтропии." },
        achv_rebirths_50_name: { en: "Cycle Veteran", ru: "Ветеран циклов" },
        achv_rebirths_50_desc: { en: "Complete 50 rebirths across all lives.", ru: "Совершите 50 перерождений за все жизни." },
        challenge_entropy_only_name: { en: "Entropy Only", ru: "Только энтропия" },
        challenge_entropy_only_desc: { en: "Face the world with evil disabled. Reward: +2 Seeds.", ru: "Пройдите мир без зла. Награда: +2 семени." },
        ...
        sidebarTravelNextUniverse: { en: "Travel to next universe (needs Unified Architecture + stability token)", ru: "Перейти в следующую вселенную (нужны Единая архитектура и токен стабильности)" },
        ...
        shopHintText: { en: "Shop items increase happiness and speed up your experience and income. Check the shop regularly and buy boosters.", ru: "Предметы магазина повышают счастье и ускоряют рост опыта и дохода. Регулярно проверяйте магазин и покупайте усилители." },
        stagnationTitle: { en: "Looks like you're stuck", ru: "Кажется, вы застряли" },
        stagnationBody: { en: "Several lives passed without new Seeds or pattern levels. That's a plateau. Try one or more of the following:", ru: "Несколько жизней подряд без новых Seeds и уровней паттернов. Это похоже на плато. Попробуйте одно или несколько действий:" },
        stagnationList1: { en: "Play a very short life to level compressedLife.", ru: "Сделайте очень короткую жизнь, чтобы качнуть compressedLife." },
        stagnationList2: { en: "Embrace Evil and progress dark magic.", ru: "Примите зло и развивайте тёмную магию." },
        stagnationList3: { en: "Temporarily turn off auto-modes and focus on Entropy or magic.", ru: "Временно выключите авто-режимы и сфокусируйтесь на энтропии или магии." },
        stagnationList4: { en: "Check the shop and buy new boosters.", ru: "Загляните в магазин и купите новые усилители." },
        stagnationList5: { en: "Invest in Velocity/Stability upgrades or push toward UA.", ru: "Вложитесь в апгрейды Скорости/Стабильности или продвигайтесь к UA." },
        stagnationButton: { en: "Got it", ru: "Понятно" },
        guide_button: { en: "Guide", ru: "Гайд" },
        guide_title: { en: "Guide & Tips", ru: "Гайд и советы" },
        guide_tab_first_run: { en: "First run", ru: "Первое прохождение" },
        guide_tab_patterns_seeds: { en: "Patterns & Seeds", ru: "Паттерны и Seeds" },
        guide_tab_entropy_evil: { en: "Entropy & Evil", ru: "Энтропия и зло" },
        guide_tab_stuck: { en: "If you're stuck", ru: "Если вы застряли" },
        guide_first_run_body: { en: "Early shop purchases make your first universe much faster: happiness, XP, and income all scale up. Auto-learn can be on, but keep an eye on income and pick strong jobs when needed. Later you'll unlock Unified Architecture to move into a new universe with different rules.", ru: "Ранние покупки в магазине сильно ускоряют первую вселенную: растут счастье, опыт и доход. Auto-learn можно включить, но следите за доходом и вручную выбирайте сильные работы. Позже вы откроете Unified Architecture и перейдёте в новую вселенную с другими правилами." },
        guide_first_run_bullet1: { en: "Check the shop and buy basic boosters (book, weights, housing) as soon as you can.", ru: "Проверьте магазин и покупайте базовые усилители (книга, гири, жильё) как только можете." },
        guide_first_run_bullet2: { en: "Use auto-learn early, but occasionally switch to a high-income job yourself.", ru: "Пользуйтесь авто-обучением, но иногда вручную переключайтесь на высокодоходные работы." },
        guide_first_run_bullet3: { en: "Watch Entropy upgrades (Velocity/Stability)  they speed up your life a lot.", ru: "Следите за апгрейдами Энтропии (Скорость/Стабильность)  они сильно ускоряют жизнь." },
        guide_patterns_body: { en: "Each life imprints a pattern. Different styles raise different patterns; Seeds are the persistent resource that power meta upgrades and UA, and they carry into new universes where they matter even more.", ru: "Каждая жизнь оставляет паттерн. Разные стили качают разные паттерны; Seeds  постоянный ресурс для мета-апгрейдов и UA, они переходят между вселенными и становятся ещё важнее в новых мирах." },
        guide_patterns_bullet1: { en: "laborCycle: most of your time working. scholarLoop: heavy study and books. opportunist: mixed work/study/entropy.", ru: "laborCycle: почти всё время в работе. scholarLoop: упор на учёбу и книги. opportunist: чередование работы/учёбы/энтропии." },
        guide_patterns_bullet2: { en: "stableCycle: very long life near max age. compressedLife: very short life (<30% lifespan, use the Eye).", ru: "stableCycle: очень длинная жизнь почти до предела. compressedLife: очень короткая жизнь (<30% lifespan, через амулет)." },
        guide_patterns_bullet3: { en: "Seeds never spend between lives/universes; they boost meta upgrades and are required for Unified Architecture.", ru: "Seeds не тратятся между жизнями и вселенными; усиливают мета-апгрейды и требуются для Unified Architecture." },
        guide_entropy_body: { en: "Evil is not a replacement for Entropy  it is a second pillar. Accepting Evil resets levels but grants Evil currency and dark magic to speed growth. In Universe II you will also see new entropy artifacts that amplify Seeds, short lives, Evil, and patterns.", ru: "Зло не замена Энтропии, это второй столб прогресса. Принятие зла сбрасывает уровни, но даёт валюту Evil и тёмную магию для ускорения роста. Во Вселенной II появятся новые энтропийные артефакты, усиливающие Seeds, короткие жизни, зло и паттерны." },
        guide_entropy_bullet1: { en: "Taking Evil is a step back in levels, forward in Evil income and dark magic.", ru: "Принятие зла откатывает уровни, но продвигает по валюте Evil и тёмной магии." },
        guide_entropy_bullet2: { en: "Train Evil and Entropy together: Evil accelerates progress, Entropy gives Seeds and meta upgrades.", ru: "Качайте зло и энтропию вместе: зло ускоряет прогресс, энтропия даёт Seeds и мета-апгрейды." },
        guide_entropy_bullet3: { en: "Unified Architecture needs Seeds and pattern levels  keep both growing.", ru: "Unified Architecture требует Seeds и уровни паттернов  растите оба." },
        guide_stuck_body: { en: "Several lives with no new Seeds or pattern levels means a plateau. Change your style to break through; if UA is ready, the next universe can also be the answer.", ru: "Если несколько жизней нет новых Seeds и уровней паттернов, это плато. Меняйте стиль, чтобы пройти дальше; если UA готова, переход в новую вселенную тоже помогает." },
        guide_stuck_bullet1: { en: "Play a very short life via the Eye to level compressedLife.", ru: "Сделайте очень короткую жизнь через амулет, чтобы качнуть compressedLife." },
        guide_stuck_bullet2: { en: "Accept Evil and push dark magic for a boost.", ru: "Примите зло и развивайте тёмную магию для ускорения." },
        guide_stuck_bullet3: { en: "Turn off auto-modes for a while and focus manually on Entropy or magic.", ru: "Выключите авто-режимы и вручную сфокусируйтесь на энтропии или магии." },
        guide_stuck_bullet4: { en: "Visit the shop and grab new boosters.", ru: "Зайдите в магазин и возьмите новые усилители." },
        guide_stuck_bullet5: { en: "Invest in Velocity/Stability upgrades and push toward UA/next universe.", ru: "Вкладывайтесь в апгрейды Скорости/Стабильности и двигайтесь к UA/следующей вселенной." },
        guide_close_button: { en: "Close", ru: "Закрыть" },
        u2_intro_title: { en: "Welcome to Universe II", ru: "Добро пожаловать во Вселенную II" },
        u2_intro_body: { en: "You've stepped into a new universe. XP and money grow a bit slower, while Entropy and Seeds grow faster and upgrades cost more. Universe II also unlocks new entropy artifacts.", ru: "Вы перешли в новую вселенную. XP и деньги растут чуть медленнее, Энтропия и Seeds  быстрее, а апгрейды стали дороже. Во Вселенной II открываются новые артефакты энтропии." },
        u2_intro_bullet1: { en: "Watch the universe indicator in the header to see active effects.", ru: "Следите за индикатором вселенной в шапке  там указаны активные эффекты." },
        u2_intro_bullet2: { en: "Check the new Entropy artifacts  they boost Seeds, short lives, Evil, and patterns in Universe II.", ru: "Загляните в новые артефакты Энтропии  они усиливают Seeds, короткие жизни, зло и паттерны во Вселенной II." },
        u2_intro_bullet3: { en: "Use what you learned in Universe I and the new modifiers to push even further.", ru: "Используйте опыт Вселенной I и новые модификаторы, чтобы продвинуться ещё дальше." },
        u2_intro_button: { en: "Continue", ru: "Продолжить" },
        universe_indicator_label: { en: "Universe", ru: "Вселенная" },
        universe_indicator_u1: { en: "Baseline rules. Standard progress.", ru: "Базовые правила. Стандартный прогресс." },
        universe_indicator_u2: { en: "XP and money are tougher; Entropy and Seeds grow faster; upgrades cost more.", ru: "XP и деньги копятся сложнее; Энтропия и Seeds растут быстрее; апгрейды дороже." },
